    ...
    request(options, function (error, response, data) {
      ...
      for(var key in json) {
        ...
        if(msg.toLowerCase() == json[key].FIRST_NAME.toLowerCase() || msg.toLowerCase() == json[key].LAST_NAME.toLowerCase() || msg.toLowerCase() == json[key].FIRST_NAME + ' ' + json[key].LAST_NAME) {
          ...
          self.postMessageToGroup('slackly-testing', "You're creating a task for " + json[key].FIRST_NAME + ". Enter the details now, please.", {as_user:true});
          userChecked = true;
...
var postObject = {
  ...
  //"COMPLETED_DATE_UTC": "2016-03-14T15:37:44.350Z",
  ...
  /*"ASSIGNED_TEAM_ID": 0,
  "ASSIGNED_DATE_UTC": "2016-03-14T15:37:44.350Z",
  "OWNER_USER_ID": 0,
  "DATE_CREATED_UTC": "2016-03-14T15:37:44.350Z",
  "DATE_UPDATED_UTC": "2016-03-14T15:37:44.350Z",
  "REMINDER_DATE_UTC": "2016-03-14T15:37:44.350Z",
  "REMINDER_SENT": true,
  "TASKLINKS": [
    {
      "TASK_LINK_ID": 0,
